...
markdown_text = """
### Re-Train the Model for Spotify Playlist Data
...
@dag(
    ...
    tags=["Re-Train", "Spotify Playlist"],
    ...
    def train_the_challenger_model():
        ...
        def mlflow_track_experiment(model, X):
            ...
            mlflow.start_run(run_name='Challenger_run_' + datetime.datetime.today().strftime('%Y/%m/%d-%H:%M:%S"'),
                             ...
                             tags={"experiment": "challenger models", "dataset": "Spotify Playlist"},
            ...
            mlflow.sklearn.log_model(
                ...
                registered_model_name="spotify_playlist_model_dev",
        ...
        def register_challenger(model, f1_score, model_uri):
            ...
            client = mlflow.MlflowClient()
            name = "spotify_playlist_model_prod"
