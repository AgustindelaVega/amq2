...
def objective(trial, X_train, y_train, experiment_id):
    ...
    with mlflow.start_run(experiment_id=experiment_id, 
        ...
        if 'SVC' in classifier_name:
            ...
            lgbm_n_estimators = trial.suggest_int("lgbm_n_estimators", 50, 200, log=True)  # Máxima profundidad de los arboles
            lgbm_max_depth = trial.suggest_int("lgbm_max_depth", 3, 10, log=True)  # Número de arboles
            lgbm_num_leaves = trial.suggest_int("lgbm_num_leaves", 31, 127, log=True)  # Número de arboles
            ...
            params["model"] = "LGBM"
            params["n_estimators"] = lgbm_n_estimators
            params["max_depth"] = lgbm_max_depth
            params["num_leaves"] = lgbm_num_leaves
